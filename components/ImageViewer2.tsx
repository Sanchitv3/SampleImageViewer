...
const ImageViewer2 = ({ isOpen, onClose, images, renderImages }: any) => {
  ...
  return (
    <View>
      {/* Fullscreen modal */}
      <Modal visible={isOpen} onRequestClose={closeModal} transparent animationType="fade">
          ...
          <GestureHandlerRootView>
            ...
            <GestureDetector gesture={composedGesture}>
              <Animated.View
                ...
                {images.slice(0, 1).map(renderImages)}
              </Animated.View>
            </GestureDetector>
          </GestureHandlerRootView>
        </Animated.View>
